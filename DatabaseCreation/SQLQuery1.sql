...
/*Insert Data */
Insert into KATHGORIA (kwdikos_kat, onomasia, perigrafh) Values ('101','ΠΟΛΥΤΕΛΕΣ','Μεγάλο αυτοκίνητο ειδικό για πολυμελής οικογένειες');
Insert into KATHGORIA (kwdikos_kat, onomasia, perigrafh) Values ('102','ΜΕΤΡΙΟΥ ΜΕΓΕΘΟΥΣ', 'Αυτοκίνητο 5πορτο, ικανό για άνετη οδήγηση');
Insert into KATHGORIA (kwdikos_kat, onomasia, perigrafh) Values ('103','ΜΙΚΡΟ', 'Αυτοκίνητο 2θέσιο, κατάλληλο για γρήγορη οδήγηση');

Insert into AYTOKINHTO (arithmos_plaisiou, xrwma, montelo, etairia_kataskeuhs, hmeromhnia_agoras, kwdikos_kat) Values ('0001', 'πράσινο', 'TIGUAN', 'VW', 12/20/05, '101');
Insert into AYTOKINHTO (arithmos_plaisiou, xrwma, montelo, etairia_kataskeuhs, hmeromhnia_agoras, kwdikos_kat) Values ('0002', 'μαύρο', 'C4', 'PEUGEOT', 5/15/09, '102');
Insert into AYTOKINHTO (arithmos_plaisiou, xrwma, montelo, etairia_kataskeuhs, hmeromhnia_agoras, kwdikos_kat) Values ('0003', 'κόκκινο', 'forfour', 'SMART', 4/13/08, '103');
Insert into AYTOKINHTO (arithmos_plaisiou, xrwma, montelo, etairia_kataskeuhs, hmeromhnia_agoras, kwdikos_kat) Values ('0004', 'γκρι', 'RAV', 'TOYOTA', 1/7/07, '101');
Insert into AYTOKINHTO (arithmos_plaisiou, xrwma, montelo, etairia_kataskeuhs, hmeromhnia_agoras, kwdikos_kat) Values ('0005', 'λευκό', 'POLO', 'VW', 9/23/08, '102');

Insert into TOPOTHESIA (kwdikos_top, odos, arithmos, polh, TK, onomatepwnumo_ypeuthinou) Values ('1111', 'αγαμέμνωνος', '25', 'Αθήνα', 16674, 'Γιώργος Παπαδόπουλος');
Insert into TOPOTHESIA (kwdikos_top, odos, arithmos, polh, TK, onomatepwnumo_ypeuthinou) Values ('1112', 'αμαλίας', '33', 'Σπάρτη', 15567, 'Δημήτρης Πρίφτης');
Insert into TOPOTHESIA (kwdikos_top, odos, arithmos, polh, TK, onomatepwnumo_ypeuthinou) Values ('1113', 'πλάτωνος', '44', 'Χανιά', 12223, 'Ιωάννης Τζημάκης');
Insert into TOPOTHESIA (kwdikos_top, odos, arithmos, polh, TK, onomatepwnumo_ypeuthinou) Values ('1114', 'σωκράτους', '101', 'Τρίκαλα', 33323, 'Δημήτρης Λάππας');
Insert into TOPOTHESIA (kwdikos_top, odos, arithmos, polh, TK, onomatepwnumo_ypeuthinou) Values ('1115', 'προόδου', '12', 'Θεσσαλονίκη', 23445, 'Μιχάλης Αγγέλου');
...
Insert into GEWGRAFIKODIAMERISMA (kwdikos_diam, onomasia, plithismos, meso_ethsio_eis) Values ('10015', 'Πελοπόννησος', 955450, 8453.55);
Insert into GEWGRAFIKODIAMERISMA (kwdikos_diam, onomasia, plithismos, meso_ethsio_eis) Values ('10025', 'Μακεδονία', 2300110, 10000);
Insert into GEWGRAFIKODIAMERISMA (kwdikos_diam, onomasia, plithismos, meso_ethsio_eis) Values ('10035', 'Στερεά Ελλάδα', 5200305, 11500);
Insert into GEWGRAFIKODIAMERISMA (kwdikos_diam, onomasia, plithismos, meso_ethsio_eis) Values ('10045', 'Ήπειρος', 900534, 10673);
Insert into GEWGRAFIKODIAMERISMA (kwdikos_diam, onomasia, plithismos, meso_ethsio_eis) Values ('10055', 'Κυκλάδες', 455673, 9556);

Insert into PELATHS (kwdikos_pel, onomatepwnumo, dieuthinsi, thlephwno, kwdikos_diam) Values ('01001', 'Γιώργος Γεωργίου', 'Ερμού 35', '6911223333', '10015');
Insert into PELATHS (kwdikos_pel, onomatepwnumo, dieuthinsi, thlephwno, kwdikos_diam) Values ('01002', 'Δημήτρης Δημητρίου', 'Άρεως 43', '6987444444', '10035');
Insert into PELATHS (kwdikos_pel, onomatepwnumo, dieuthinsi, thlephwno, kwdikos_diam) Values ('01003', 'Γεωργία Λημνιάτη', 'Σόλωνος 55', '6934506789', '10025');
Insert into PELATHS (kwdikos_pel, onomatepwnumo, dieuthinsi, thlephwno, kwdikos_diam) Values ('01004', 'Δήμητρα Καρέλη', 'Δημούτσου 5', '6933567859', '10055');
Insert into PELATHS (kwdikos_pel, onomatepwnumo, dieuthinsi, thlephwno, kwdikos_diam) Values ('01005', 'Kωνσταντίνος Λαγός', 'Ντίνα 44', '6980706050', '10025');
...
Insert into ODHGOS (kwdikos_pel, onomatepwnumo_od, hlikia) Values ('01002', 'Σπύρος Γεωργίου', 36);
Insert into ODHGOS (kwdikos_pel, onomatepwnumo_od, hlikia) Values ('01004', 'Παναγιώτης Σπυρόπουλος', 44);
Insert into ODHGOS (kwdikos_pel, onomatepwnumo_od, hlikia) Values ('01002', 'Δήμητρα Γεωργίου', 19);
Insert into ODHGOS (kwdikos_pel, onomatepwnumo_od, hlikia) Values ('01002', 'Χριστίνα Δημητρίου', 39);
Insert into ODHGOS (kwdikos_pel, onomatepwnumo_od, hlikia) Values ('01005', 'Χρήστος Λαγός', 20);
