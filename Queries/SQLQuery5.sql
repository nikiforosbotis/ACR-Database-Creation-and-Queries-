...
BEGIN
	PRINT 'ΑΥΤΟΚΙΝΗΤΟ: ' + 'αριθμός πλαισίου: ' + @arithmos_plaisiou + 'χρώμα: ' + @xrwma + 'μοντέλο: ' + @montelo + 'εταιρία κατασκευής: ' + @etairia_kataskeuhs + 'ημερομηνία αγοράς: ' + cast(@hmeromhnia_agoras as CHAR(20)) + 'κωδικός κατηγορίας: ' + @kwdikos_kat
